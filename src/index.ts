...
// TODO: Use this to generate user token to paste into frontend (or store in JWT)
// const userId = 'react-app'; // Replace with the actual user ID
// const userToken = serverClient.createToken(userId);
// console.log('Generated userToken:', userToken);
